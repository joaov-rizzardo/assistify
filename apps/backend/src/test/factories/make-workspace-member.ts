...
import { WorkspaceMember, WorkspaceMemberRoles } from 'src/application/core/entities/workspace-member';
...
export class WorkspaceMemberFactory {
  ...
  async makePrismaWorkspaceMember(workspaceId: string, userId: string, args: MakePrismaUserArgs) {
