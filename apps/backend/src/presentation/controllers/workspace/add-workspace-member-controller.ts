...
export class AddWorkspaceMemberController {
  constructor(private readonly addWorkspacemMemberUseCase: AddWorkspaceMemberUseCase) {}
  ...
  @Post('/add')
  async handle(@Body() { role, userId }: AddWorkspaceMemberDTO, @Req() req: WorkspaceRequest) {
