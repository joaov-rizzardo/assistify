...
export abstract class TokenGenerator {
  ...
  abstract decodeRefreshToken(token: string): Promise<RefreshTokenPayload> | RefreshTokenPayload;
  abstract decodeAccessToken(token: string): Promise<AccessTokenPayload> | AccessTokenPayload;
}
