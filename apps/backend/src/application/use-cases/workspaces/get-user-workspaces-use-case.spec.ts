...
describe('Get user workspaces use case', () => {
  ...
  beforeEach(async () => {
    ...
    sut = new GetUserWorkspacesUseCase(workspaceRepository, workspaceMembersRepository);
  ...
  it('should return an empty array when user does not has unknown workspaces', async () => {
