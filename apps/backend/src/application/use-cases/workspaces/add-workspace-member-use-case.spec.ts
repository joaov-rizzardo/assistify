...
describe('Add workspace member use case', () => {
  ...
  beforeEach(async () => {
    ...
    sendWorkspaceInviteUseCase = new SendWorkspaceInviteUseCase(userSocketEmitter, userNotificationRepository);
    sut = new AddWorkspaceMemberUseCase(userRepository, workspaceMembersRepository, sendWorkspaceInviteUseCase);
  ...
  it('should send notification to invited user', async () => {
    ...
    const notification = (userNotificationRepository as InMemoryUserNotificationRepository).notifications[0];
