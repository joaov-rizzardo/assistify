...
//     socket.ev.on('creds.update', this.sessionStore.saveCreds.bind(this.sessionStore));
...
//   private handleConnectionUpdate({ connection, lastDisconnect }: Partial<ConnectionState>) {
//     if (connection === 'close') {
