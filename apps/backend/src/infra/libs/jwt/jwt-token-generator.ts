import { AccessTokenPayload, RefreshTokenPayload, TokenGenerator } from 'src/application/core/interfaces/tokens/token-generator';
...
export class JwtTokenGenerator implements TokenGenerator {
  ...
  private readonly REFRESH_TOKEN_SECRET = getEnvVariable('REFRESH_TOKEN_SECRET');
  ...
  decodeAccessToken(token: string): AccessTokenPayload | Promise<AccessTokenPayload> {
