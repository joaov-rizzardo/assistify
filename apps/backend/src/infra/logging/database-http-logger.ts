import { HttpLogger, LogData, LogLevels } from 'src/application/core/interfaces/logging/http-logger';
...
export class DatabaseHttpLogger implements HttpLogger {
  ...
  async log(level: LogLevels, message: string, logData: LogData): Promise<void> {
